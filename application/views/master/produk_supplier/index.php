<ol class="breadcrumb pull-right">
    ...
    <li class="breadcrumb-item"><a>Data Produk Supplier</a></li>
</ol>
    ...
    <div class="col-lg-12">
        <div class="panel panel-inverse">
            <div class="panel-heading">
                <h4 class="panel-title">Data Produk Supplier</h4>
            </div>
    ...
    $(document).ready(function() {
        ...
        table = $('#table').DataTable({
            initComplete: function() {
                var url;
                url = "<?= site_url('master/produk_supplier/') ?>";
            ...
            "ajax": {
                "url": "<?php echo site_url('master/produk_supplier/getDataProduk/') ?>",
                "type": "POST",
                "data": function(data) {
                    // data.tgl = $('#tgl').val();
                    // data.tgl2 = $('#tgl2').val();
